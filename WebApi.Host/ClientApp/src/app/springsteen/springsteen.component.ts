...
export class SpringsteenComponent {
  concerts: {
    ...
    expanded: boolean
      ...
      { date: new Date(1985, 6, 3), location: "Wembley Stadium, London", tour: "Born in the USA Tour", tracks: [{ id: 1, title: "Born in the USA" }, { id: 2, title: "Badlands" }, { id: 3, title: "Darlington County" }, { id: 4, title: "Seeds" }, { id: 5, title: "Johnny 99" }, { id: 6, title: "Atlantic City" }, { id: 7, title: "The River" }, { id: 8, title: "Working On The Highway" }, { id: 9, title: "Trapped" }, { id: 10, title: "Out In The Street" }, { id: 11, title: "Glory Days" }, { id: 12, title: "The Promised Land" }, { id: 13, title: "My Hometown" }, { id: 14, title: "Thunder Road" }, { id: 15, title: "Cover Me" }, { id: 16, title: "Dancing In The Dark" }, { id: 17, title: "Hungry Heart" }, { id: 18, title: "Cadillac Ranch" }, { id: 19, title: "Downbound Train" }, { id: 20, title: "I'm On Fire" }, { id: 21, title: "Because The Night" }, { id: 22, title: "Rosalita (Come Out Tonight)" }, { id: 23, title: "Can't Help Falling In Love" }, { id: 24, title: "Born To Run" }, { id: 25, title: "Bobby Jean" }, { id: 26, title: "Two Hearts" }, { id: 27, title: "Ramrod" }, { id: 28, title: "Twist And Shout" }], expanded: false },
      { date: new Date(1988, 5, 25), location: "Wembley Stadium, London", tour: "Tunnel of Love Express Tour", expanded: false },
